...
- Glow types ≤ 2  
- Radius tokens ≤ 4  
- Heading hierarchy %100 consistent  
- Motion durations standardized  

### Risk → Mitigation
| Risk | Mitigation |
|------|------------|
| Token değişikliği 40+ component etkiler | Önce token dokümanı; sonra kademeli rollout (Storybook yoksa sayfa bazlı) |

### Rollback
CSS variables / component variant PR revert.
